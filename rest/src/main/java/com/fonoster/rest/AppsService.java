...
public class AppsService {
    ...
    public Response getApps(@QueryParam("start") String start,
        ...
        List<App> apps = AppsAPI.getInstance().getApps(account.getUser(),
            jStart,
            jEnd,
            pageSize,
            pageSize * page,
    ...
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    @Path("/{appId}")
    public Response getApp(@PathParam("appId") String appId, @Context HttpServletRequest httpRequest) throws ApiException {
    ...
    @Path("/{appId}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public Response deleteApp(@PathParam("appId") String appId, @Context HttpServletRequest httpRequest) throws ApiException {
        Account account = AuthUtil.getAccount(httpRequest);
