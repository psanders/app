...
public class RecordingsService {
  ...
  public Response getRecordings(
    ...
    List<Recording> recordings =
        RecordingsAPI.getInstance().getRecordings(account, jStart, jEnd, page, page * pageSize);
  ...
  public Response getRecording(
    ...
    if (result == null || result.isEmpty() || aFormat != null) {
      File file =
          RecordingsAPI.getInstance()
              .getRecordingFileById(account, new ObjectId(recordingId), aFormat);
      String ext = "wav";
      if (aFormat != null) {
