...
public class Conversation {
  ...
  public void then(JSFunc func) {
    ...
    Collections.sort(
        intents, (intent2, intent1) -> intent1.getConfidence().compareTo(intent2.getConfidence()));
  ...
  public static class Result {
    ...
    public Result(
        final String intent, final double confidence, final List<MessageResponse.Entity> entities) {
